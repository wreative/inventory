...
@section('title', __('pages.title').__(' | Tambah Perlengkapan'))
@section('titleContent', __('Tambah Perlengkapan'))
@section('breadcrumb', __('Data'))
@section('morebreadcrumb')
<div class="breadcrumb-item active">{{ __('Perlengkapan') }}</div>
<div class="breadcrumb-item active">{{ __('Tambah Perlengkapan') }}</div>
@endsection
